...
ActiveRecord::Schema[7.0].define(version: 2023_08_23_220325) do
  ...
  create_table "booking_stations", force: :cascade do |t|
    ...
    t.index ["ticket_id"], name: "index_booking_stations_on_ticket_id"
  ...
  create_table "buses", force: :cascade do |t|
    ...
    t.bigint "ticket_id", null: false
    t.bigint "track_id", null: false
    t.index ["ticket_id"], name: "index_buses_on_ticket_id"
    t.index ["track_id"], name: "index_buses_on_track_id"
  end
  ...
  create_table "tracks", force: :cascade do |t|
    ...
    t.bigint "bus_id", null: false
    t.bigint "ticket_id", null: false
    t.bigint "booking_stations_id", null: false
    t.index ["booking_stations_id"], name: "index_tracks_on_booking_stations_id"
    t.index ["bus_id"], name: "index_tracks_on_bus_id"
  ...
  add_foreign_key "booking_stations", "tickets"
  add_foreign_key "booking_stations", "tracks"
  add_foreign_key "buses", "tickets"
  add_foreign_key "buses", "tracks"
  add_foreign_key "tickets", "booking_stations"
  add_foreign_key "tickets", "buses"
  add_foreign_key "tickets", "tracks"
  add_foreign_key "tickets", "users"
  add_foreign_key "tracks", "booking_stations", column: "booking_stations_id"
  add_foreign_key "tracks", "buses"
